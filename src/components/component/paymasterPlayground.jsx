...
// const paymasterAddress = "YOUR_PAYMASTER_CONTRACT_ADDRESS"; // Replace with your paymaster contract address
// const greeterAddress = "YOUR_GREETER_CONTRACT_ADDRESS"; // Replace with your greeter contract address
...
//       const greeterContract = new ethers.Contract(greeterAddress, ["function setGreeting(string _greeting)"], signer);
//       const paymasterContract = new ethers.Contract(paymasterAddress, ["function payForTransaction(address _to, uint256 _value, bytes _data)"], signer);

//       const txData = greeterContract.interface.encodeFunctionData("setGreeting", [newGreeting]);
//       const tx = await paymasterContract.payForTransaction(greeterAddress, 0, txData);
//       await tx.wait();
...
//       setError("Failed to change greeting. Please try again later.");
//     }
//   };
...
//               className="flex-grow text-lg"
//             />
//             <Button onClick={handleGreetingChange} className="ml-2">
//               Change Greeting
//             </Button>
//           </div>
//           {blockData && (
